...
LedgerEntryResultingLedgerAccountBalances: TypeAlias = Union[LedgerBalances, Optional[object]]
...
class LedgerEntry(BaseModel):
    ...
    resulting_ledger_account_balances: LedgerEntryResultingLedgerAccountBalances
    """
