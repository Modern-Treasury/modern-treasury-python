...
class LedgerEntriesResultingLedgerAccountBalancesPendingBalance(BaseModel):
    amount: int
...
class LedgerEntriesResultingLedgerAccountBalancesPostedBalance(BaseModel):
    amount: int
...
class LedgerEntriesResultingLedgerAccountBalancesAvailableBalance(BaseModel):
    amount: int
...
class LedgerEntriesResultingLedgerAccountBalances(BaseModel):
    available_balance: LedgerEntriesResultingLedgerAccountBalancesAvailableBalance
    """
    ...
    pending_balance: LedgerEntriesResultingLedgerAccountBalancesPendingBalance
    """The pending_balance is the sum of all pending and posted entries."""

    posted_balance: LedgerEntriesResultingLedgerAccountBalancesPostedBalance
    """The posted_balance is the sum of all posted entries."""


class LedgerEntries(BaseModel):
    amount: int
    ...
    resulting_ledger_account_balances: Optional[LedgerEntriesResultingLedgerAccountBalances]
    """
