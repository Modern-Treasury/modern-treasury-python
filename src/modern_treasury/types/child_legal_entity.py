...
__all__ = [
    ...
    "LegalEntityAssociationsChildLegalEntityRegulators",
    "LegalEntityAssociationChildLegalEntityRegulator",
    "LegalEntityAssociationsChildLegalEntityTermsOfUse",
    "LegalEntityAssociationChildLegalEntityTermsOfUse",
]
...
class LegalEntityAssociationChildLegalEntityAddress(BaseModel):
    id: str
...
class LegalEntityAssociationChildLegalEntityIdentification(BaseModel):
    id: str
...
class LegalEntityAssociationChildLegalEntityPhoneNumber(BaseModel):
    """A list of phone numbers in E.164 format."""
...
class LegalEntityAssociationChildLegalEntityRegulator(BaseModel):
    jurisdiction: str
    """
    The country code where the regulator operates in the ISO 3166-1 alpha-2 format
    (e.g., "US", "CA", "GB").
...
LegalEntityAssociationsChildLegalEntityRegulators = LegalEntityAssociationChildLegalEntityRegulator
"""This type is deprecated and will be removed in a future release.

Please use LegalEntityAssociationChildLegalEntityRegulator instead.
"""


class LegalEntityAssociationChildLegalEntityTermsOfUse(BaseModel):
    """Acceptance of terms of use by the legal entity."""
...
LegalEntityAssociationsChildLegalEntityTermsOfUse = LegalEntityAssociationChildLegalEntityTermsOfUse
"""This type is deprecated and will be removed in a future release.

Please use LegalEntityAssociationChildLegalEntityTermsOfUse instead.
"""


class LegalEntityAssociationChildLegalEntity(BaseModel):
    """The child legal entity."""

    id: str

    addresses: List[LegalEntityAssociationChildLegalEntityAddress]
    ...
    identifications: List[LegalEntityAssociationChildLegalEntityIdentification]
    ...
    phone_numbers: List[LegalEntityAssociationChildLegalEntityPhoneNumber]
    ...
    regulators: Optional[List[LegalEntityAssociationChildLegalEntityRegulator]] = None
    ...
    terms_of_use: Optional[LegalEntityAssociationChildLegalEntityTermsOfUse] = None
    """Acceptance of terms of use by the legal entity."""
