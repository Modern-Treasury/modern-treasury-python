...
class ReturnObject(BaseModel):
    ...
    type: Literal["ach", "ach_noc", "au_becs", "bacs", "book", "check", "cross_border", "eft", "gb_fps", "manual", "neft", "nz_becs", "rtp", "sepa", "stablecoin", "wire", "zengin"]
    """The type of return.
