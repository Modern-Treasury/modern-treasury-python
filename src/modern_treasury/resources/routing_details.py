...
from ..types import routing_detail_create_params
from ..types import routing_detail_list_params
...
class RoutingDetails(SyncAPIResource):
    ...
    *,
    ...
    payment_type: Optional[Literal["ach", "au_becs", "bacs", "book", "card", "chats", "check", "cross_border", "dk_nets", "eft", "gb_fps", "masav", "mx_ccen", "neft", "nics", "nz_becs", "pl_elixir", "rtp", "se_bankgirot", "sepa", "sg_giro", "sic", "stablecoin", "wire", "zengin"]] | Omit = omit,
    ...
    idempotency_key: str | None = None,) -> RoutingDetail:
        """
        ...
        return self._post(
            path_template("/api/{accounts_type}/{account_id}/routing_details", accounts_type=accounts_type, account_id=account_id),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> RoutingDetail:
        """
        ...
        return self._get(
            path_template("/api/{accounts_type}/{account_id}/routing_details/{id}", accounts_type=accounts_type, account_id=account_id, id=id),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> SyncPage[RoutingDetail]:
        """
...
class AsyncRoutingDetails(AsyncAPIResource):
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> AsyncPaginator[RoutingDetail, AsyncPage[RoutingDetail]]:
        """
        Get a list of routing details for a single internal or external account.
