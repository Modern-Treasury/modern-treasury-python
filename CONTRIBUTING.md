...
`src/modern_treasury/lib/` and `examples/` directories are exceptions and will never be overridden.
...
```bash
pip install git+ssh://git@github.com:Modern-Treasury/modern-treasury-python.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/Modern-Treasury/modern-treasury-python/actions/workflows/publish-pypi.yml). This will require a setup organization or repository secret to be set up.
