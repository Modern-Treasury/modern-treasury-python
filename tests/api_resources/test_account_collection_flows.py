...
class TestAccountCollectionFlows:
    ...
    def test_method_create(self, client: ModernTreasury) -> None:
        ...
        assert_matches_type(AcccountConnectionFlow, account_collection_flow, path=["response"])
    ...
    def test_method_list(self, client: ModernTreasury) -> None:
        ...
        assert_matches_type(SyncPage[AcccountConnectionFlow], account_collection_flow, path=["response"])
...
class TestAsyncAccountCollectionFlows:
    ...
    async def test_method_list(self, client: AsyncModernTreasury) -> None:
        ...
        assert_matches_type(AsyncPage[AcccountConnectionFlow], account_collection_flow, path=["response"])
