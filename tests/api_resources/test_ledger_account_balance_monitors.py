...
class TestAsyncLedgerAccountBalanceMonitors:
    ...
    async def test_path_params_retrieve(self, client: AsyncModernTreasury) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await client.ledger_account_balance_monitors.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_path_params_update(self, client: AsyncModernTreasury) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await client.ledger_account_balance_monitors.with_raw_response.update(
                "",
            )
    ...
    async def test_path_params_delete(self, client: AsyncModernTreasury) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await client.ledger_account_balance_monitors.with_raw_response.delete(
                "",
            )
