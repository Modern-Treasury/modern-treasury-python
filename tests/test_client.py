...
class TestModernTreasury:
    ...
    def test_raw_response(self, respx_mock: MockRouter, client: ModernTreasury) -> None:
    ...
    def test_copy(self, client: ModernTreasury) -> None:
        copied = client.copy()
        ...
        copied = client.copy(organization_id="another my-organization-ID")
        assert copied.organization_id == "another my-organization-ID"
        assert client.organization_id == "my-organization-ID"

    def test_copy_default_options(self, client: ModernTreasury) -> None:
    ...
    def test_copy_build_request(self, client: ModernTreasury) -> None:
    ...
    def test_request_timeout(self, client: ModernTreasury) -> None:
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
    ...
    def test_hardcoded_query_params_in_url(self, client: ModernTreasury) -> None:
    ...
    def test_request_extra_json(self, client: ModernTreasury) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_headers(self, client: ModernTreasury) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_query(self, client: ModernTreasury) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: ModernTreasury) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_basic_union_response(self, respx_mock: MockRouter, client: ModernTreasury) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_client_response_validation_error(self, respx_mock: MockRouter, client: ModernTreasury) -> None:
        class Model(BaseModel):
            foo: str
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: ModernTreasury) -> None:
        respx_mock.post("/api/counterparties").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            client.counterparties.with_streaming_response.create(name="name").__enter__()

        assert _get_open_connections(client) == 0

    @mock.patch("modern_treasury._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: ModernTreasury) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects(self, respx_mock: MockRouter, client: ModernTreasury) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects_disabled(self, respx_mock: MockRouter, client: ModernTreasury) -> None:
...
class TestAsyncModernTreasury:
    ...
    def test_copy(self, async_client: AsyncModernTreasury) -> None:
        ...
        copied = async_client.copy(organization_id="another my-organization-ID")
        assert copied.organization_id == "another my-organization-ID"
        assert async_client.organization_id == "my-organization-ID"

    def test_copy_default_options(self, async_client: AsyncModernTreasury) -> None:
        # options that have a default are overridden correctly
    ...
    @pytest.mark.skipif(sys.version_info >= (3, 10), reason="fails because of a memory leak that started from 3.12")
    def test_copy_build_request(self, async_client: AsyncModernTreasury) -> None:
        options = FinalRequestOptions(method="get", url="/foo")
    ...
    async def test_request_timeout(self, async_client: AsyncModernTreasury) -> None:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncModernTreasury) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncModernTreasury) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_basic_union_response(self, respx_mock: MockRouter, async_client: AsyncModernTreasury) -> None:
        class Model1(BaseModel):
            name: str
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        ...
        with pytest.raises(APITimeoutError):
            await async_client.counterparties.with_streaming_response.create(name="name").__aenter__()
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects(self, respx_mock: MockRouter, async_client: AsyncModernTreasury) -> None:
        # Test that the default follow_redirects=True allows following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects_disabled(self, respx_mock: MockRouter, async_client: AsyncModernTreasury) -> None:
        # Test that follow_redirects=False prevents following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
