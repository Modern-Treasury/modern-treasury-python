...
class PaymentOrders(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        subtype: Optional[Literal["CCD", "CIE", "CTX", "IAT", "PPD", "TEL", "WEB"]] | NotGiven = NOT_GIVEN,
        amount: int,
    ...
    @required_args(["body"], ["type", "amount", "direction", "originating_account_id"])
    def create(
        self,
        body: PaymentOrderCreateParams | None = None,
        *,
        type: Literal[
            "ach",
            "au_becs",
        ...
        if body is not None:
            ...
            # with the standard PaymentOrderCreateParams type.
            body = cast(
                Any,
                {
                    "type": type,
    ...
    def update(
        self,
        id: str,
        body: PaymentOrderUpdateParams | None = None,
        *,
        type: Literal[
            "ach",
            "au_becs",
        ...
        if body is not None:
            ...
            # cast to Any is required because the NotGiven types make this expression incompatible
            # with the standard PaymentOrderUpdateParams type.
            body = cast(
                Any,
                {
                    "type": type,
    ...
    def list(
        self,
        query: PaymentOrderListParams | None = None,
        *,
        after_cursor: Optional[str] | NotGiven = NOT_GIVEN,
        per_page: int | NotGiven = NOT_GIVEN,
        type: Literal[
        ...
        if query is not None:
            ...
            # cast to Any is required because the NotGiven types make this expression incompatible
            # with the standard PaymentOrderListParams type.
            query = cast(
                Any,
                {
    ...
    def create_async(
        self,
        body: PaymentOrderCreateAsyncParams | None = None,
        *,
        type: Literal[
            "ach",
            "au_becs",
        ...
        if body is not None:
            ...
            # cast to Any is required because the NotGiven types make this expression incompatible
            # with the standard PaymentOrderCreateAsyncParams type.
            body = cast(
                Any,
                {
                    "type": type,
