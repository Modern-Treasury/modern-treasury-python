...
>
> If you want to migrate to the new patterns incrementally you can do so by installing `v0.4.0`. This release contains both
...
This section outlines the features that were deprecated in `v0.4.0`, and subsequently removed in `v0.5.0` and how to migrate your code.
